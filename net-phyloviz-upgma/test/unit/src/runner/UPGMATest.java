...
import net.phyloviz.upgma.algorithm.upgma.UPGMADistance;
...
//        run(size);
    ...
    private void run(int size) throws IOException{
        ...
        HierarchicalClusteringDistance ad = new UPGMADistance();
       
        long init = 0, end = 0;
        init = System.currentTimeMillis();
        
        UPGMA algorithm = new UPGMA(td, ad, new OutputPanel("upgma-test"));
