...
public final class UPGMAWizardAction extends NodeAction {
	...
	protected void performAction(Node[] nodes) {
		...
		wizardDescriptor.setTitle("Hierarchical Clustering Configuration");
...
/**
	...
	public String getName() {
		return "Run Hierarchical Clustering";
	}
