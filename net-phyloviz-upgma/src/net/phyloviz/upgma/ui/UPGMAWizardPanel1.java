...
public class UPGMAWizardPanel1 implements WizardDescriptor.ValidatingPanel {

	/**
	 * The visual component that displays this panel. If you need to access the
	 * component from this class, just use getComponent().
	 */
	private UPGMAVisualPanel1 component;

	private Node node;

	public UPGMAWizardPanel1(Node node) {
		super();
		this.node = node;
	}
	...
	public Component getComponent() {
		if (component == null) {
			...
			component = new UPGMAVisualPanel1(td);
		}
	...
	public void storeSettings(Object settings) {
		((WizardDescriptor) settings).putProperty("distance", ((UPGMAVisualPanel1) getComponent()).getDistance());
	}
