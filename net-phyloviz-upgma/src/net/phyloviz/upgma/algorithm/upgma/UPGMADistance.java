...
public class UPGMADistance implements HierarchicalClusteringDistance{
    ...
    public int level(Edge<UPGMALeafNode> e) {
        throw new UnsupportedOperationException("UPGMADistance - level");
    }

    @Override
    public int compare(Edge<UPGMALeafNode> f, Edge<UPGMALeafNode> e) {
        throw new UnsupportedOperationException("UPGMADistance - compareEdges");
    }

    @Override
    public int compare(UPGMALeafNode px, UPGMALeafNode py) {
        throw new UnsupportedOperationException("UPGMADistance - compareNodes");
    }

    @Override
    public Comparator<UPGMALeafNode> getProfileComparator() {
        throw new UnsupportedOperationException("UPGMADistance - getProfileComparator");
    }

    @Override
    public Comparator<Edge<UPGMALeafNode>> getEdgeComparator() {
        throw new UnsupportedOperationException("UPGMADistance - getEdgeComparator");
    }
