...
public class SLDistance implements HierarchicalClusteringDistance {
    ...
    public int level(Edge<UPGMALeafNode> e) {
        throw new UnsupportedOperationException("Single-Linkage - level");
    }

    @Override
    public int compare(Edge<UPGMALeafNode> f, Edge<UPGMALeafNode> e) {
        throw new UnsupportedOperationException("Single-Linkage - compareEdges");
    }

    @Override
    public int compare(UPGMALeafNode px, UPGMALeafNode py) {
        throw new UnsupportedOperationException("Single-Linkage - compareNodes");
    }

    @Override
    public Comparator<UPGMALeafNode> getProfileComparator() {
        throw new UnsupportedOperationException("Single-Linkage - getProfileComparator");
    }

    @Override
    public Comparator<Edge<UPGMALeafNode>> getEdgeComparator() {
        throw new UnsupportedOperationException("Single-Linkage - getEdgeComparator");
    }

    @Override
    public String toString() {
        return "Single-Linkage distance";
    }
