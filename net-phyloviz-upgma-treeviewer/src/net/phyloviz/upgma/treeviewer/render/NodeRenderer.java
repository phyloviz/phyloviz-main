...
import static prefuse.render.AbstractShapeRenderer.RENDER_TYPE_DRAW;
...
public class NodeRenderer extends AbstractShapeRenderer {
     ...
     */
    public NodeRenderer(String textField, TreeView uv) {
    ...
    protected Shape getRawShape(VisualItem item) {
        ...
        if ( m_bbox instanceof RoundRectangle2D ) {
            ...
            if(st != null){
                boolean linear = tv.getLinearSize();
                w += (int) (linear ? 12 * st.getFreq() : (12 * Math.log(1 + st.getFreq())));
            }
