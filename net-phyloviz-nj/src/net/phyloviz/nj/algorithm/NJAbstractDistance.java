 ...
 * @author Adriano
 */
public abstract class NJAbstractDistance implements AbstractDistance<NJLeafNode>{
    ...
    public abstract NJ getAlgorithm(TypingData<? extends Profile> inTd, AbstractDistance<NJLeafNode> inAd, OutputPanel op);
