...
import net.phyloviz.welcome.content.Logo;
...
class BottomBar extends JPanel {
    ...
    public BottomBar() {
        ...
        add(  new JLabel() /* Logo.createOracleLogo() */, new GridBagConstraints(0,0,1,1,0.0,0.0,
        ...
        add( Logo.createPhylovizLogo(), new GridBagConstraints(4,0,1,1,0.0,0.0,
