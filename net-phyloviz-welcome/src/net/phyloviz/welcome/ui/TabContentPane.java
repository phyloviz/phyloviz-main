...
class TabContentPane extends JPanel {
    ...
    public TabContentPane() {
        ...
        leftShadow = ImageUtilities.loadImage("net/phyloviz/welcome/resources/left_shadow.png");
        rightShadow = ImageUtilities.loadImage("net/phyloviz/welcome/resources/right_shadow.png");
        bottomShadow = ImageUtilities.loadImage("net/phyloviz/welcome/resources/bottom_shadow.png");
        bottomLeftCorner = ImageUtilities.loadImage("net/phyloviz/welcome/resources/bottom_left_corner.png");
        bottomRightCorner = ImageUtilities.loadImage("net/phyloviz/welcome/resources/bottom_right_corner.png");
    }
