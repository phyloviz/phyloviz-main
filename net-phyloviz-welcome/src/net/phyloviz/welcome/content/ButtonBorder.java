...
package net.phyloviz.welcome.content;
...
public class ButtonBorder implements Border {
    ...
    private ButtonBorder( boolean mouseOver ) {
        if( mouseOver ) {
            imgTopLeft = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-top-lef.png");
            imgTopRight = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-top-right.png");
            imgBottomLeft = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-bott-left.png");
            imgBottomRight = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-bott-right.png");
            imgLeft = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-side-left.png");
            imgRight = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-side-right.png");
            imgTop = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-top.png");
            imgBottom = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-bottom.png");
            imgCenter = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-sel-center.png");
        } else {
            imgTopLeft = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-top-lef.png");
            imgTopRight = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-top-right.png");
            imgBottomLeft = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-bott-left.png");
            imgBottomRight = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-bott-right.png");
            imgLeft = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-side-left.png");
            imgRight = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-side-right.png");
            imgTop = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-top.png");
            imgBottom = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-bottom.png");
            imgCenter = ImageUtilities.loadImage("net/phyloviz/welcome/resources/butt-center.png");
        }
    }
