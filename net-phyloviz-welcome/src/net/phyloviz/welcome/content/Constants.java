...
public interface Constants {
    ...
    //static final String ORACLE_LOGO_IMAGE = "net/phyloviz/welcome/resources/oracle_logo.png"; // NOI18N
    static final String PHYLOVIZ_LOGO_IMAGE = "net/phyloviz/welcome/resources/phyloviz_logo.png"; // NOI18N

    static final String IMAGE_TOPBAR_CENTER = "net/phyloviz/welcome/resources/topbar_center.png"; // NOI18N
    static final String IMAGE_TOPBAR_LEFT = "net/phyloviz/welcome/resources/topbar_left.png"; // NOI18N
    static final String IMAGE_TOPBAR_RIGHT = "net/phyloviz/welcome/resources/topbar_right.png"; // NOI18N
    static final String IMAGE_TOPBAR_LOGO = "net/phyloviz/welcome/resources/nb_logo.png"; // NOI18N

    static final String BROKEN_IMAGE = "net/phyloviz/welcome/resources/broken_image.png"; // NOI18N
    static final String IMAGE_PICTURE_FRAME = "net/phyloviz/welcome/resources/picture_frame.png"; // NOI18N
