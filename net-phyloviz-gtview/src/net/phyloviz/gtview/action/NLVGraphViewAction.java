...
import net.phyloviz.gtview.ui.NLVGraphGTPanel;
...
public class NLVGraphViewAction extends NodeAction {
	...
	protected void performAction(Node[] nodes) {
		...
		NLVGraphGTPanel tvp = new NLVGraphGTPanel(nodes[0].getParentNode().getDisplayName() + ": " + nodes[0].getDisplayName(), gr, td);
		tvp.open();
		tvp.requestActive();
	...
	private class LocalNodeListener implements NodeListener {
		...
		private final NLVGraphGTPanel tvp;

		LocalNodeListener(NLVGraphGTPanel tvp) {
			this.tvp = tvp;
		}
