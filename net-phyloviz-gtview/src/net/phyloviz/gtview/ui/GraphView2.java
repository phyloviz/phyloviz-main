...
public class GraphView2 extends net.phyloviz.upgmanjcore.visualization.GView {
    ...
    public GraphView2(String name, GOeBurstMSTResult _er, boolean isLinear, Map<String, Point> nodesPositions) {
    ...
    public void loadGraph(final Collection<Edge<GOeBurstNode>> edges, final AbstractDistance ad, final boolean loaded) {
