...
public class NLVGraphGraphView extends net.phyloviz.upgmanjcore.visualization.GView {
	...
	public NLVGraphGraphView(String name, Result _er) {
		...
		exportButton.setIcon(new ImageIcon(NLVGraphGraphView.class.getResource("export.png")));
