...
public class SLVGraphGTPanel extends TopComponent {
	...
	public SLVGraphGTPanel(String name, GOeBurstResult gr, TypingData<? extends Profile> ds) {
		super(Lookups.singleton(gr));
		initComponents();
		this.setName(name);
		gv = new SLVGraphView(name, gr);
		this.add(gv);
		gv.startAnimation();
