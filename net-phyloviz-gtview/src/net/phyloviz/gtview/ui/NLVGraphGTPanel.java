...
public class NLVGraphGTPanel extends TopComponent {
	...
	public NLVGraphGTPanel(String name, final net.phyloviz.nlvgraph.Result gr, TypingData<? extends Profile> ds) {
		super(Lookups.singleton(gr));
		initComponents();
		this.setName(name);
		gv = new NLVGraphGraphView(name, gr);
		this.add(gv);
		//gv.run();
		//gv.startAnimation();
