...
public class WizardPanel1 implements WizardDescriptor.ValidatingPanel {
	 ...
	 */
	private VisualPanel1 component;

	private final Node node;

	public WizardPanel1(Node node) {
		super();
		this.node = node;
	}
	...
	public void readSettings(Object settings) {
		((WizardDescriptor) settings).putProperty("WizardPanel_image", ImageUtilities.loadImage("net/phyloviz/nlvgraph/nLVGraphImage.png", true));
	}
	...
	public void validate() throws WizardValidationException {
		...
		int maxLevel = component.getMaxLevel();

		if (maxLevel < 0)
			throw new WizardValidationException(null, "Invalid maximum level", null);
