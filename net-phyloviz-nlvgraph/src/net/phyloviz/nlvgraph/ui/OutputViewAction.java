...
@ActionID(category="PHYLOViZ/nLVGraph", id="net.phyloviz.nlvgraph.ui.OutputViewAction")
@ActionRegistration(displayName="Output")
@ActionReference(path="Actions/PHYLOViZ/nLVGraph", position=10)
