...
public final class GenDatasetWizardAction implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		wizardDescriptor.setTitle(org.openide.util.NbBundle.getMessage(GenDatasetWizardAction.class, "GenDatasetWizardAction.title"));
	...
	private WizardDescriptor.Panel[] getPanels() {
		if (panels == null) {
			panels = new WizardDescriptor.Panel[]{
				new GenDatasetWizardPanel1(),
				new GenDatasetWizardPanel2(),
				new GenDatasetWizardPanel3()
				};
