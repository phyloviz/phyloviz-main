...
public class WeightDistanceProvider implements DistanceProvider<GOeBurstNode> {

	@Override
	public AbstractDistance<GOeBurstNode> getDistance(TypingData td) {

		if (td.getItems().isEmpty() || !(td.getItems().iterator().next() instanceof MLVAType))
			return null;
		
		return new WeightDistance(td);
	}
	...
	public AbstractDistance<GOeBurstNode> getDistance(TypingData td, int maxLevel) {
		...
		return new WeightDistance(td, maxLevel);
	}
