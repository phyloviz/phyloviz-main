...
public class GOeBurstMSTNode extends AbstractNode {

	public GOeBurstMSTNode(GOeBurstMSTResult g) {
	...
	public Image getIcon (int type) {
		return ImageUtilities.loadImage("net/phyloviz/goeburst/GOeBurstMSTIcon.png");
	}
	...
	public Action[] getActions(boolean context) {
		...
		Collection<? extends Action> a4p = Utilities.actionsForPath("/Actions/PHYLOViZ/GOeBurstMST");
